...
public class PostMyEdmAdapter extends ArrayAdapter<PostMyEdm> {

	private LayoutInflater mInflater = null;
	public PostMyEdm storage = new PostMyEdm();
	StorageEdmRelativeLayoutDatas layoutDatas;
	ArrayList<PostMyEdm> currentListPost = new ArrayList<PostMyEdm>();
	int resourceTV =0;
	...
	final public View getView(final int position, View convertView,
		...
		PostMyEdm entity = getItem(position);
