...
public final class ImageLoader {
     ...
     */
    public BindResult bind(BaseAdapter adapter, ImageView view, String url, ImageTransformer it) {
        if (adapter == null) {
        ...
        if (bitmap != null) {
            ...
            if (error != null) {
                ...
                ImageRequest request = new ImageRequest(adapter, url, it);
     ...
     * @throws NullPointerException if any of the arguments are {@code null}.
     */
    public BindResult bind(BaseExpandableListAdapter adapter, ImageView view, String url, ImageTransformer it) {
        if (adapter == null) {
            throw new NullPointerException("Adapter is null");
        }
        if (view == null) {
     ...
     */
    public BindResult bind(ImageView view, String url, Callback callback, ImageTransformer it) {
        if (view == null) {
            throw new NullPointerException("ImageView is null");
        }
        if (url == null) {
        ...
        if (bitmap != null) {
            ...
            if (error != null) {
                ...
                ImageRequest request = new ImageRequest(view, url, callback, it);
    ...
    private class ImageRequest {
        ...
        private ImageTransformer mImageTransfo;

        private ImageRequest(String url, ImageCallback callback, boolean loadBitmap, ImageTransformer it) {
            mUrl = url;
            mCallback = callback;
         ...
         */
        public ImageRequest(BaseAdapter adapter, String url, ImageTransformer it) {
            this(url, new BaseAdapterCallback(adapter), true, it);
        }
         ...
         */
        public ImageRequest(BaseExpandableListAdapter adapter, String url, ImageTransformer it) {
            this(url, new BaseExpandableListAdapterCallback(adapter), true, it);
        }
         ...
         * {@link ImageView}.
         */
        public ImageRequest(ImageView view, String url, Callback callback, ImageTransformer it) {
            this(url, new ImageViewCallback(view, callback), true, it);
        }
        ...
        public boolean execute() {
            try {
                ...
                if (mLoadBitmap) {
                    ...
                    if (mImageTransfo != null)
                    {
                		mBitmap = mImageTransfo.transform(mBitmap);
                    }
                    return true;
                } else {
    ...
    public static abstract class ImageTransformer{
